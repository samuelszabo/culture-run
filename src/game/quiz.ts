...
export const QUIZZES: Record<string, QuizQuestion[]> = {
  ...
  'egypt-pyramids': [
    {
      id: 'q1',
      questionKey: 'quiz.egypt-pyramids.q1.question',
      optionKeys: [
        'quiz.egypt-pyramids.q1.opt0',
        'quiz.egypt-pyramids.q1.opt1',
        'quiz.egypt-pyramids.q1.opt2',
      ],
      correctIndex: 1,
      bonus: 25,
    },
    {
      id: 'q2',
      questionKey: 'quiz.egypt-pyramids.q2.question',
      optionKeys: [
        'quiz.egypt-pyramids.q2.opt0',
        'quiz.egypt-pyramids.q2.opt1',
        'quiz.egypt-pyramids.q2.opt2',
      ],
      correctIndex: 0,
      bonus: 25,
    },
    {
      id: 'q3',
      questionKey: 'quiz.egypt-pyramids.q3.question',
      optionKeys: [
        'quiz.egypt-pyramids.q3.opt0',
        'quiz.egypt-pyramids.q3.opt1',
        'quiz.egypt-pyramids.q3.opt2',
      ],
      correctIndex: 2,
      bonus: 25,
    },
    {
      id: 'q4',
      questionKey: 'quiz.egypt-pyramids.q4.question',
      optionKeys: [
        'quiz.egypt-pyramids.q4.opt0',
        'quiz.egypt-pyramids.q4.opt1',
        'quiz.egypt-pyramids.q4.opt2',
      ],
      correctIndex: 1,
      bonus: 25,
    },
